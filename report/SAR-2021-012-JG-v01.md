...
## Estimativa da renda total recebida por deputados da bancada evangélica
...
A interpretação conjunta destes dois resultados é que, na média, a renda total dos deputados evangélicos é menor que a renda total dos outros deputados.
No entanto o tamanho do efeito da renda, ajustado pelas outras variáveis, não pode ser estimado com precisão suficiente para quantificar sua magnitude.
...
Por fim, o número de votos parece ser maior, apesar de não ser significativo: para cada 100 mil votos recebidos a mais, a chance de um deputado ser da bancada evangélica é aumentada
(OR: 1.26 (95% CI 1.01, 1.73; p=0.10)).
Esta conclusão é suportada por uma análise univariada *ad-hoc* do efeito desta variável
(OR: -0.71 (95% CI -0.90, -0.53; p<0.001)).
...
Apesar disso, eles recebem 26% mais votos e atingem maior capilaridade que os deputados não evangélicos.
